                    ...
                    <div class="modal-body">
                        ...
                        <form action="" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Category Name In English">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Category Name In Japanese">
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a href="#edit_modal" data-toggle="modal" class=" btn btn-default fa fa-edit"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>Company 1</td>
